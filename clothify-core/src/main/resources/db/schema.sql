...
CREATE TABLE order_header (
    ...
    status           ENUM('PENDING', 'CONFIRMED', 'COMPLETED', 'CANCELLED') NOT NULL DEFAULT 'COMPLETED',
    order_source     ENUM('POS', 'ONLINE') NOT NULL DEFAULT 'POS',
...
INSERT INTO employee (name, phone, email, address, hire_date, active)
VALUES ('Web Orders', '0000000000', 'web@clothify.com', 'Online', CURDATE(), 1);

INSERT INTO `user` (username, password_hash, role, employee_id)
VALUES ('web_orders', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 'STAFF', 2);
